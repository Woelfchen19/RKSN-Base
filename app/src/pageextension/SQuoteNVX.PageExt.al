pageextension 50026 "SQuoteNVX" extends "Sales Quote"
{
    layout
    {
    ...
    trigger OnOpenPage()
    begin
        AppMgt.SetFieldsPropertyVisibleEditableBySetup(ObjectType::Page, Page::"Sales Quote", DimVisible, DimEditable);
