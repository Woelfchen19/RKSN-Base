page 50038 "ReminderControlBusFieldListNVX"
{
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                {
                    ToolTip = 'Specifies the value of the Reminder Assosiated field.', Comment = 'DEA="Mahnung zugehörig"';
                    ApplicationArea = All;
                }
    ...
    begin
        if Rec.IsEmpty() then begin
            Rec.Init();
            Rec.ReminderSetupExtension := Rec.ReminderSetupExtension::BusinessField;
            Rec.Insert();
        end;
    end;
}