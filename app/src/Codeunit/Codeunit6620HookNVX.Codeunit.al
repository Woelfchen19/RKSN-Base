codeunit 50013 Codeunit6620HookNVX
{
    ...
    begin
        ...
        BEGIN
            IF DocInfo.get(DocInfo.Department::Sales, CopyDocMgt.SalesHeaderDocType(FromDocType), FromDocNo) then begin
                NewDocInfo.Init();
        ...
        BEGIN
            IF PstdDocInfo.get(PstdDocInfo.Department::Sales, PstdDocInfo."Document Type"::Invoice, FromDocNo) then begin
                NewDocInfo.Init();
                NewDocInfo.TransferFields(PstdDocInfo);
                NewDocInfo."Document Type" := ToSalesHeader."Document Type";
                NewDocInfo."Document No." := ToSalesHeader."No.";
        ...
        BEGIN
            IF PstdDocInfo.get(PstdDocInfo.Department::Sales, PstdDocInfo."Document Type"::"Credit Memo", FromDocNo) then begin
                NewDocInfo.Init();
                NewDocInfo.TransferFields(PstdDocInfo);
                NewDocInfo."Document Type" := ToSalesHeader."Document Type";
                NewDocInfo."Document No." := ToSalesHeader."No.";
