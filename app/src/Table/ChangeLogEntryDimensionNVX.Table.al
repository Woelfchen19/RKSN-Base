table 50019 "ChangeLogEntryDimensionNVX"
{
    DataClassification = CustomerContent;
    Caption = 'Change Log Entry Dimension', comment = 'DEA="Änderungsprotokol Dimension"';
    DrillDownPageID = ChangeLogEntriesListNVX;
    LookupPageID = ChangeLogEntriesListNVX;
    ReplicateData = true;
    ...
    procedure GetPrimaryKeyFriendlyName(): Text
    var
        RecRef: RecordRef;
        FriendlyName: Text;
        p: Integer;
    ...
    local procedure OnAfterIsProtected(var ChangeLogEntry: Record ChangeLogEntryDimensionNVX; var ProtectedRecord: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeCheckIfLogEntryCanBeDeleted(var ChangeLogEntry: Record ChangeLogEntryDimensionNVX; var IsHandled: Boolean)
    begin
    end;
}
