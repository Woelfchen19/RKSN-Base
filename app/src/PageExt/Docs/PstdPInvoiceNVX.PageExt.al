pageextension 50030 PstdPInvoiceNVX extends "Posted Purchase Invoice"
{
    layout
    {
    ...
    begin
        PstdDocInfoNVX.Get(PstdDocInfoNVX.Department::Purchase,PstdDocInfoNVX."Document Type"::Invoice,"No.");
    end;
}