pageextension 50008 SOrderNVX extends "Sales Order"
{
    layout
    {
        addfirst("Invoice Details")
        {
            field(GenBsnPstGrpNVX;"Gen. Bus. Posting Group")
            {
                ...
                begin
                    ...
                    GBPGRec.Reset();
                    repeat
                        if GenBsnPstGrpNVX.Get(GBPGRec.Code) and GenBsnPstGrpNVX."Filter Sales Order" then
                            GBPGRec.Mark(true);
