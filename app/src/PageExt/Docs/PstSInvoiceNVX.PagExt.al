pageextension 50032 PstdSInvoiceNVX extends "Posted Sales Invoice"
{
    layout
    {
    ...
    begin
        PstdDocInfoNVX.Get(PstdDocInfoNVX.Department::Sales,PstdDocInfoNVX."Document Type"::Invoice,"No.");
    end;
}